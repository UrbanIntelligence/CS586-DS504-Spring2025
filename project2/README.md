...
- **Important Notes**:
  ...
  3. The accuracy value must be a floating-point number formatted to **4 decimal places**, don't change the line **"print(f"Accuracy={test_accu:.4f}")"** for the correct output for the autograder.
